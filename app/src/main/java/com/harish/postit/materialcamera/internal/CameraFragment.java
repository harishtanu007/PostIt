...
import com.harish.postit.materialcamera.util.Degrees;
import com.harish.postit.materialcamera.util.ImageUtil;
import com.harish.postit.materialcamera.util.ManufacturerUtil;

import static com.harish.postit.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static com.harish.postit.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static com.harish.postit.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static com.harish.postit.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static com.harish.postit.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static com.harish.postit.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  com.harish.postit.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new com.harish.postit.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof com.harish.postit.materialcamera.internal.CameraPreview)
