...
import com.harish.postit.easyvideoplayer.EasyVideoCallback;
import com.harish.postit.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(com.harish.postit.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(com.harish.postit.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(com.harish.postit.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
